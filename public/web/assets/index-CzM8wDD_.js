import{_ as N}from"./index-ByJwDCaU.js";import{r as i,c as x,o as m,w as h,d as e,b as n,aN as L,aO as T,n as E,F as S,p as C,u as A,_ as U,T as M,J as $,Y as O,Z as P,E as V,cx as B,as as z,a6 as F,t as j,U as D}from"./index-AWZvdbgs.js";import{_ as R}from"./index-BWkpR5g6.js";import{_}from"./index-CiMiumU_.js";const k={html:`<!DOCTYPE HTML>
<html>
<head>
...
`};function H(v,d,l){return`<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8" />
...
`}const G={style:{display:"flex","align-items":"center","margin-bottom":"12px"}},W={style:{flex:"1"}},Y={style:{flex:"1"}},q={style:{border:"1px solid var(--el-border-color)"}},K={__name:"demo-basic",setup(v){const d=Object.keys(k),l=i(""),r=i("typescript"),p=i("vs-dark"),g=()=>{l.value=k[r.value]};return g(),(u,a)=>{const s=T,b=L,y=R;return m(),x(y,{header:"代码编辑器","body-style":{padding:"12px"}},{default:h(()=>[e("div",G,[a[3]||(a[3]=e("div",null,"主题：",-1)),e("div",W,[n(b,{modelValue:p.value,"onUpdate:modelValue":a[0]||(a[0]=o=>p.value=o),class:"ele-fluid","popper-options":{strategy:"fixed"}},{default:h(()=>[n(s,{value:"vs",label:"Visual Studio"}),n(s,{value:"vs-dark",label:"Visual Studio Dark"}),n(s,{value:"hc-light",label:"High Contrast"}),n(s,{value:"hc-black",label:"High Contrast Dark"})]),_:1},8,["modelValue"])]),a[4]||(a[4]=e("div",null," 语言：",-1)),e("div",Y,[n(b,{modelValue:r.value,"onUpdate:modelValue":a[1]||(a[1]=o=>r.value=o),class:"ele-fluid","popper-options":{strategy:"fixed"},onChange:g},{default:h(()=>[(m(!0),E(S,null,C(A(d),o=>(m(),x(s,{key:o,value:o,label:o},null,8,["value","label"]))),128))]),_:1},8,["modelValue"])])]),e("div",q,[n(_,{modelValue:l.value,"onUpdate:modelValue":a[2]||(a[2]=o=>l.value=o),language:r.value,theme:p.value,style:{height:"460px"}},null,8,["modelValue","language","theme"])])]),_:1})}}},X={style:{border:"1px solid var(--el-border-color)"}},Z={__name:"demo-diff",setup(v){const d=i(`/**
 * 下载文件
 * @param data 二进制数据
 * @param name 文件名
 * @param type 文件类型
...
`),p=i("javascript");return(g,u)=>{const a=R;return m(),x(a,{header:"代码差异对比","body-style":{padding:"12px"}},{default:h(()=>[e("div",X,[n(_,{modelValue:d.value,"onUpdate:modelValue":u[0]||(u[0]=s=>d.value=s),language:l.value,original:r.value,"onUpdate:original":u[1]||(u[1]=s=>r.value=s),"original-language":p.value,diff:!0,style:{height:"460px"}},null,8,["modelValue","language","original","original-language"])])]),_:1})}}},J={class:"run-wrapper"},Q={class:"editor-wrapper"},ee={class:"editor-item"},te={class:"editor-item-header"},ne={class:"editor-item-body"},ae={class:"editor-item"},oe={class:"editor-item-body"},ie={class:"editor-item"},re={class:"editor-item-body"},se={class:"result-wrapper"},le={class:"frame-header"},de={class:"result-body"},ce={class:"console-wrapper"},ue={__name:"demo-run",setup(v){const d=i(`<div style="text-align: center;padding-top: calc(50vh - 24px);">
...
`),p=i(null),g=i(0),u=i(null),a=i([]),s=o=>{var f,w;if(!o){g.value++,D(()=>{s(!0)});return}a.value=[];const t=(w=(f=p.value)==null?void 0:f.contentWindow)==null?void 0:w.document;t&&(t.open(),t.write(H(l.value,d.value,r.value)),t.close())},b=o=>{o.data&&o.data.id==="iframeConsole"&&(a.value.push(o.data),D(()=>{var t,f;(f=(t=u.value)==null?void 0:t.scrollTo)==null||f.call(t,0,u.value.scrollHeight)}))};M(()=>{window.addEventListener("message",b),s(!0)}),$(()=>{window.removeEventListener("message",b)});const y=i(!1);return O(()=>{y.value&&(s(!0),y.value=!1)}),P(()=>{y.value=!0}),(o,t)=>{const f=V,w=R;return m(),x(w,{header:"代码运行","body-style":{padding:"12px"}},{default:h(()=>[e("div",J,[e("div",Q,[e("div",ee,[e("div",te,[n(f,{class:"editor-item-icon"},{default:h(()=>[n(A(B))]),_:1}),t[4]||(t[4]=e("div",null,"HTML",-1))]),e("div",ne,[n(_,{modelValue:d.value,"onUpdate:modelValue":t[0]||(t[0]=c=>d.value=c),language:"html",style:{height:"128px"}},null,8,["modelValue"])])]),e("div",ae,[t[5]||(t[5]=e("div",{class:"editor-item-header"},[e("div",{class:"editor-item-icon is-css"},"*"),e("div",null,"CSS")],-1)),e("div",oe,[n(_,{modelValue:l.value,"onUpdate:modelValue":t[1]||(t[1]=c=>l.value=c),language:"css",style:{height:"220px"}},null,8,["modelValue"])])]),e("div",ie,[t[6]||(t[6]=e("div",{class:"editor-item-header"},[e("div",{class:"editor-item-icon is-js"},"{}"),e("div",null,"JS")],-1)),e("div",re,[n(_,{modelValue:r.value,"onUpdate:modelValue":t[2]||(t[2]=c=>r.value=c),language:"javascript",style:{height:"320px"}},null,8,["modelValue"])])])]),e("div",se,[e("div",le,[t[7]||(t[7]=e("div",{class:"frame-tool"},null,-1)),t[8]||(t[8]=e("div",{class:"frame-tool is-warning"},null,-1)),t[9]||(t[9]=e("div",{class:"frame-tool is-success"},null,-1)),t[10]||(t[10]=e("div",{style:{margin:"1.68px 2px 0 auto","font-size":"12px"}},"重新运行",-1)),e("div",{class:"frame-btn",onClick:t[3]||(t[3]=c=>s())},[n(f,{style:{transform:"scale(1.09) translate(0.38px, 0.48px)"}},{default:h(()=>[n(A(z))]),_:1})])]),e("div",de,[(m(),E("iframe",{key:g.value,ref_key:"iframeRef",ref:p}))]),e("div",ce,[t[11]||(t[11]=e("div",{class:"console-header"},[e("span",{style:{"font-family":"Consolas","vertical-align":"-1px"}},[e("span",{style:{"font-size":"18px"}},">"),e("span",{style:{margin:"0 4px 0 -4px","vertical-align":"2px"}},"_")]),e("span",null,"Console")],-1)),e("div",{ref_key:"consoleBodyRef",ref:u,class:"console-body"},[(m(!0),E(S,null,C(a.value,(c,I)=>(m(),E("pre",{key:I,class:F(["console-item",{"is-error":c.type==="error"},{"is-warn":c.type==="warn"}])},j(c.code),3))),128))],512)])])])]),_:1})}}},me=U(ue,[["__scopeId","data-v-8f57fba5"]]),ve=Object.assign({name:"ExtensionMonaco"},{__name:"index",setup(v){return(d,l)=>{const r=N;return m(),x(r,null,{default:h(()=>[n(K),n(Z),n(me)]),_:1})}}});export{ve as default};
